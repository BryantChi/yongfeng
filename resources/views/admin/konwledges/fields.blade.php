...
<div class="form-group col-sm-6">
    ...
    <div class="img-preview-cover mt-2">
        @if ($konwledge->image ?? null)
            <p for="">預覽</p>
            <img src="{{ env('APP_URL', 'https://035519000.com.tw') . '/uploads/' . $konwledge->image }}"
...
@endpush
@push('page_scripts')
<script src="{{ asset('assets/admin/js/konwledge.js') }}" referrerpolicy="no-referrer"></script>
<script>
